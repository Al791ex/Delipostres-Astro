        ...
        <div className="row">
          <div className="col-12 col-lg-6 p-3 p-md-5 bg-gray-100">
            ...
            <div className="form-group">
              ...
              <input type="email" className="form-control" placeholder="Ingresa la dirección de correo" />
            </div>

            <h5 className="mt-5 mb-4">Dirección de envío</h5>
            <ShippingInfo />

            <h5 className="mt-5 mb-4">Detalles de pago</h5>
            <PaymentDetails />

            <h5 className="mt-5 mb-4">Facturación</h5>
            <BillingInfo />
          ...
          <div className="col-12 col-lg-6 p-3 p-md-5 bg-dark bg-gradient rounded-end">
            <p className="text-white opacity-6 mb-0 text-end">Monto</p>
