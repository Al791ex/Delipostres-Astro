    ...
    <div className="card shadow-xs border p-3 p-md-4 mb-4">
        ...
        <div className="d-block d-md-flex justify-content-between align-items-center">
          <div className="d-block d-md-flex">
            <div className="d-flex d-md-block justify-content-between p-4 me-md-4">
              <p className="text-sm mb-0">Id de Orden</p>
              <h6>{order.orderNumber}</h6>
            </div>
            <div className="d-flex d-md-block justify-content-between p-4 me-md-4">
              <p className="text-sm mb-0">Fecha de colocación</p>
              <h6>{order.date}</h6>
            </div>
            <div className="d-flex d-md-block justify-content-between p-4">
              <p className="text-sm mb-0">Costo</p>
              <h6>Bs.2,570</h6>
            </div>
          </div>
              ...
              <div className="modal-content">
                    ...
                    <div className="card-header text-center">
                      <div className="row justify-content-between">
                        ...
                        <div className="col-lg-4 col-md-5 text-end">
                          ...
                          <h4 className="mt-7 mb-1">Facturado a:</h4>
                      ...
                      <div className="row justify-content-md-between">
                        <div className="col-md-4">
                          <h4 className="mt-5 text-start">Factura no. <br /><small className="mr-2">#XK98321111</small></h4>
                        </div>
                        <div className="col-lg-4 col-md-5">
                          <div className="d-flex align-items-center mt-5 ms-auto float-end">
                            <div className="text-sm me-3 font-weight-bold">Fecha de factura:</div>
                            <div className="text-end">22 de enero 2024</div>
                          </div>
                          <div className="d-flex align-items-center ms-auto float-end">
                            <div className="text-sm me-3 font-weight-bold">Fecha de vencimiento:</div>
                            <div className="text-end">22 de febrero 2024</div>
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <table className="table text-right">
                          <thead className="bg-default">
                            <tr>
                              ...
                              <th scope="col" className="text-right text-white">Candtidad</th>
                              <th scope="col" className="text-right text-white">Rate</th>
                              <th scope="col" className="text-right text-white">Costo</th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr>
                ...
                <div className="card-footer text-right">
                  <div className="col-md-5 ms-auto text-end">
                    <h5>Thank you!</h5>
                    <p className="text-sm">Si tiene algún problema relacionado con la factura, puede contactarnos en: </p>
                    <h6 className="mb-0">
                      email:
      ...
      <div className="table-responsive">
        <table className="table">
          <thead>
            <tr>
              <th scope="col" className="text-secondary text-xs font-weight-bold border-light ps-2">Producto</th>
              <th scope="col" className="text-secondary text-xs font-weight-bold border-light ps-2">Precio</th>
              <th scope="col" className="text-secondary text-xs font-weight-bold border-light ps-2">Estatus</th>
              <th scope="col" className="text-secondary text-xs font-weight-bold border-light ps-2">Fecha</th>
              <th scope="col" className="text-secondary text-xs font-weight-bold border-light ps-2 text-end">Detalles</th>
            </tr>
          </thead>
          <tbody>
            {orderHistoryCards}
