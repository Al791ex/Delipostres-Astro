  ...
  return (
    <>
      <div className="card shadow-xs border p-3 p-md-4 mb-4">
        ...
        <div className="mt-4">
          <h6 className="text-center">Preparandose para el envío</h6>
          ...
          <div className="d-block d-md-flex justify-content-between">
            <div className="d-block text-center">
              ...
              <p className="font-weight-semibold text-dark">Orden colocada</p>
            </div>
            {status == "Order Placed" && 
            <>
              <div className="d-block text-center">
                ...
                <p className="font-weight-semibold">Procesada</p>
              </div>
              <div className="d-block text-center">
                <div className="icon icon-shape icon-sm bg-secondary text-white text-center border-radius-sm d-flex align-items-center justify-content-center mb-3 mx-auto">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p className="font-weight-semibold">Enviado</p>
              </div>
              <div className="d-block text-center">
                <div className="icon icon-shape icon-sm bg-secondary text-white text-center border-radius-sm d-flex align-items-center justify-content-center mb-3 mx-auto">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p className="font-weight-semibold">Entregado</p>
              </div>
            </>
            }
            {status == "Processed" && 
            <>
              <div className="d-block text-center">
                ...
                <p className="font-weight-semibold text-dark">Procesado</p>
              </div>
              <div className="d-block text-center">
                <div className="icon icon-shape icon-sm bg-secondary text-white text-center border-radius-sm d-flex align-items-center justify-content-center mb-3 mx-auto">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <>
              ...
              <div className="d-block text-center">
                ...
                <p className="font-weight-semibold text-dark">Enviado</p>
              </div>
              <div className="d-block text-center">
                <div className="icon icon-shape icon-sm bg-secondary text-white text-center border-radius-sm d-flex align-items-center justify-content-center mb-3 mx-auto">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <>
              ...
              <div className="d-block text-center">
                ...
                <p className="font-weight-semibold text-dark">Entregado</p>
              </div>
            </>
            }
          </div>
